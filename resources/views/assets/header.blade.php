...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('EndUserAssets/img/favicon.ico') }}" rel="icon">
    ...
    <link href="{{ asset('EndUserAssets/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('EndUserAssets/css/style.css') }}" rel="stylesheet">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <!-- Fonts -->
...
<body>
        ...
        <div class="row align-items-center bg-dark px-lg-5">
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-sm bg-dark p-0">
                    <ul class="navbar-nav ml-n2 align-items-center">
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            {{ $isActive = '' }}
            <div class="navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="{{ route('dashboard') }}"
                        class="nav-item nav-link {{ $isActive = $_SERVER['REQUEST_URI'] == '/dashboard' ? 'active' : '' }}">Home</a>
                    <a href="{{ route('categories') }}"
                        class="nav-item nav-link {{ $isActive = $_SERVER['REQUEST_URI'] == '/categories' ? 'active' : '' }}">Category</a>
                    <a href="{{ route('trending') }}"
                        class="nav-item nav-link {{ $isActive = $_SERVER['REQUEST_URI'] == '/trending' ? 'active' : '' }}">Single
                        News</a>
                    ...
                    <a href="{{ route('contactUs') }}"
                        class="nav-item nav-link {{ $isActive = $_SERVER['REQUEST_URI'] == '/contact-us' ? 'active' : '' }} ">Contact</a>
                </div>
