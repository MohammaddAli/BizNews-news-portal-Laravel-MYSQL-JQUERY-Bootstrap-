<div class="col-lg-4">
    ...
    <div class="mb-3">
        ...
        <div class="bg-white text-center border border-top-0 p-3">
            <a href=""><img class="img-fluid" src="{{ asset('EndUserAssets/img/news-800x500-2.jpg') }}"
                    alt=""></a>
        </div>
    </div>
    <!-- Ads End -->
                ...
                <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                    <div class="mb-2">
                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2"
                            href=""><?php echo $singleTrendingNews['categoryName']; ?></a>
                        <a class="text-body" href=""><small><?php echo $singleTrendingNews['publish_date']; ?></small></a>
                    </div>
                    <a class="h6 m-0 text-secondary text-uppercase font-weight-bold"
                        href="./single.php?id=<?php echo $singleTrendingNews['single_news_id']; ?>" style="overflow: hidden;"><?php echo $singleTrendingNews['title']; ?></a>
                </div>
            </div> <?php } ?> --}}
        ...
        <div class="bg-white border border-top-0 p-3">
            <div class="d-flex flex-wrap m-n1">
                ...
                <a href="./category_view_all.php?id=<?php echo $category['id']; ?>"
                    class="btn btn-sm btn-outline-secondary m-1"><?php echo $category['name']; ?> </a>
                <?php } ?> --}}
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="m-n1">
                ...
                @foreach ($allCategories as $category)
                    <a href="{{ route('categoryAll', $category->id) }}"
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="row">
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="{{ asset('EndUserAssets/img/news-110x110-1.jpg') }}"
                            alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="{{ asset('EndUserAssets/img/news-110x110-2.jpg') }}"
                            alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="{{ asset('EndUserAssets/img/news-110x110-3.jpg') }}"
                            alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="{{ asset('EndUserAssets/img/news-110x110-4.jpg') }}"
                            alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="{{ asset('EndUserAssets/img/news-110x110-5.jpg') }}"
                            alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="{{ asset('EndUserAssets/img/news-110x110-1.jpg') }}"
...
<script src="{{ asset('EndUserAssets/lib/easing/easing.min.js') }}"></script>
