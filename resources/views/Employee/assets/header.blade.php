        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="{{ route('employee.categories.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('employee.articles.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="http://localhost/BizNews/admin_dashboard/single_news_images/add_single_news_images.php"
                                class="nav-link">
